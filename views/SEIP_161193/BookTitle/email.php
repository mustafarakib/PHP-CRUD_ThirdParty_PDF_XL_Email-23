...
$yourGmailAddress = 'YourUsername@gmail.com';
$yourGmailPassword = 'YourGmailPassword';
...
{
    printf("I'm recommending You: [<strong>Book ID: </strong>%s, <strong>Book Name: </strong>%s, <strong>Author Name: </strong>%s]",$singleItem->id,$singleItem->book_name,$singleItem->author_name);
